...
#Oracle WebApi
dotnet new nrsrx-webapi -n My.NRSRx1.WebApi -S true -Ev Redis -L Elasticsearch -D Oracle -o ./tests/My.NRSRx1.WebApi --force
dotnet build ./tests/My.NRSRx1.WebApi

dotnet new nrsrx-webapi -n My.NRSRx2.WebApi -S true -Ev Redis -E Asset -L Splunk -D Oracle -o ./tests/My.NRSRx2.WebApi --force
dotnet build ./tests/My.NRSRx2.WebApi


#Oracle WebApi Tests
dotnet new nrsrx-webapi-tests -n My.NRSRx1.WebApi.Tests -S true  -Ev Redis -D Oracle -o ./tests/My.NRSRx1.WebApi.Tests --force
...
dotnet new nrsrx-webapi-tests -n My.NRSRx2.WebApi.Tests -S true -Ev Redis -D Oracle -E Asset -o ./tests/My.NRSRx2.WebApi.Tests --force
