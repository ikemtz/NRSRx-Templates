...
#Oracle OData
dotnet new nrsrx-odata -n My.NRSRx1.OData -S true -L Elasticsearch -D Oracle -o ./tests/My.NRSRx1.OData --force
dotnet build ./tests/My.NRSRx1.OData

dotnet new nrsrx-odata -n My.NRSRx2.OData -S true -E Asset -L Splunk -D Oracle -o ./tests/My.NRSRx2.OData --force
dotnet build ./tests/My.NRSRx2.OData

#Oracle OData Tests
dotnet new nrsrx-odata-tests -n My.NRSRx1.OData.Tests -S true -o ./tests/My.NRSRx1.OData.Tests --force -D Oracle
...
dotnet new nrsrx-odata-tests -n My.NRSRx2.OData.Tests -S true -E Asset -o ./tests/My.NRSRx2.OData.Tests --force -D Oracle
